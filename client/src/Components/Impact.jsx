  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl px-6 mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-items-center">
        <motion.div className="bg-blue-100 p-6 rounded-lg shadow-md w-60 flex flex-col items-center"
        ...
        <motion.div className="bg-green-100 p-6 rounded-lg shadow-md w-60 flex flex-col items-center"
          initial={{ opacity: 0, y: 150 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
        >
        ...
        <motion.div className="bg-yellow-100 p-6 rounded-lg shadow-md w-60 flex flex-col items-center"
          initial={{ opacity: 0, x: 150 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
        >
