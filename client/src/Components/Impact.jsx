...
const Impact = () => {
  return (
    ...
    >
        ...
        >
        <h1 className='text-4xl font-bold'> OurImpact </h1>
        </motion.div>
      </div>
      <p className="mt-4 max-w-2xl mx-auto">
        We are committed to transforming lives through education, awareness, and women empowerment. Here’s what we’ve achieved so far:
      </p>
      <div className="max-w-6xl px-6 mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto">
        ...
        <div className="bg-green-100 p-6 rounded-lg shadow-md w-60 flex flex-col items-center">
          ...
          <p className="mt-2 text-gray-700">Community Projects</p>
        </div>
        <div className="bg-yellow-100 p-6 rounded-lg shadow-md w-60 flex flex-col items-center">
          ...
          <p className="mt-2 text-gray-700">People Reached</p>
        </div>
      </div>
    </motion.section>
  );
